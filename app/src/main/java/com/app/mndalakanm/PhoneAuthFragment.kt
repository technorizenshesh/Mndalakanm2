...
import com.app.mndalakanm.databinding.FragmentPhoneAuthBinding
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener(requireActivity()) { task ->
                if (task.isSuccessful) {
                    ...
                    Log.w(TAG, "signInWithCredentiaailure", task.exception)
    ...
    private fun updateUI(
        ...
        when (uiState) {
            ...
            STATE_CODE_SENT -> {
                ...
                binding.detail.setText("status_code_sent")
            }
            STATE_VERIFY_FAILED -> {
                ...
                binding.detail.setText("status_verification_failed")
            }
            STATE_VERIFY_SUCCESS -> {
                ...
                binding.detail.setText("status_verification_succeeded")
                ...
                if (cred != null) {
                    if (cred.smsCode != null) {
                        ...
                        binding.fieldVerificationCode.setText("instant_validation")
                    }
                }
            }
            STATE_SIGNIN_FAILED ->
                // No-op, handled by sign-in check
                binding.detail.setText("status_sign_in_failed")
        ...
        if (user == null) {
            ...
            binding.status.setText("signed_in")
